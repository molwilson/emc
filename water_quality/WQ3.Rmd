...
ggplot() +
  ...
  scale_shape_manual(name = "Sample date", labels = c("April 2021", "August 2021", "April 2022"), values = c(1, 16, 8)) +
  labs(x = "", y = "pH") +
  ylim(5, 9) +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(here("water_quality", "figs", "WQ3", "pH.png"), width = 6, height = 4)
...
ggplot() +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(here("water_quality", "figs", "WQ3", "tds.png"), width = 6, height = 4)
...
ggplot() +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(here("water_quality", "figs", "WQ3", "salinity.png"), width = 6, height = 4)
...
ggplot() +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(here("water_quality", "figs", "WQ3", "turbidity.png"), width = 6, height = 4)
...
ggplot() +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(here("water_quality", "figs", "WQ3", "do.png"), width = 6, height = 4)
...
ggplot() +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(here("water_quality", "figs", "WQ3", "nitrate.png"), width = 6, height = 4)
...
ggplot() +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(here("water_quality", "figs", "WQ3", "phosphate.png"), width = 6, height = 4)
...
ggplot() +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(here("water_quality", "figs", "WQ3", "temperature.png"), width = 6, height = 4)
...
ggplot() +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(here("water_quality", "figs", "WQ3", "conductivity.png"), width = 6, height = 4)
...
ggplot() +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave(here("water_quality", "figs", "WQ3", "enterococci.png"), width = 6, height = 4)
```
...
ggarrange(ph, do, tds, turbidity, nitrates, phosphates, temperature, enterococci, salinity, conductivity, 
          ncol = 2, nrow = 5)
ggsave(here("water_quality", "figs", "WQ3", "summary.png"), width = 6, height = 12)
```
