...
ggsave(here("water_quality", "figs", "WQ4", "summary_sites.png"),  width = 6, height = 10)
```
...
ggarrange(ph, do, tds, turbidity, nitrates, phosphates, temperature, enterococci, salinity, conductivity, 
          ncol = 2, nrow = 5)
ggsave(here("water_quality", "figs", "WQ4", "summary.png"), width = 6, height = 10)
```
...
ggsave(here("water_quality", "figs", "WQ4", "sargassum.png"), width = 6, height = 10)
```
