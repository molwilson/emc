...
```{r}
guess_encoding(here("water_quality", "data_raw", "Kor Measurement File Export - Jan 2026.csv"))
guess_encoding(here("water_quality", "data_raw", "Kor Measurement File Export - Mar 2026.csv"))
guess_encoding(here("water_quality", "data_raw", "Kor Measurement File Export - Apr 2026.csv"))
guess_encoding(here("water_quality", "data_raw", "Kor Measurement File Export - May 2026.csv"))

# import raw YSI data from Kor .csv export 
raw <- read_csv(here("water_quality", "data_raw", "Kor Measurement File Export - Mar 2026.csv"),
  col_names = FALSE,
  show_col_types = FALSE) %>%
  filter(!str_detect(X1, "MEAN VALUE|STANDARD DEVIATION|SENSOR SERIAL NUMBER"))

# import raw YSI data from Kor .csv export - UTF encoded files
lines <- read_lines(
  here("water_quality", "data_raw", "Kor Measurement File Export - Apr 2026.csv"),
...
write_csv(ysi, here("water_quality", "data_outputs", "kor_exports", "ysi_clean_mar2026.csv"))
