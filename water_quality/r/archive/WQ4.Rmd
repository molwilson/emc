...
samples <- read_excel(here("water_quality", "data", "samples.xlsx"), sheet = "raw_data") %>%  
  ...
  mutate(id_site = paste0(id_site, ")"),
         date_cat = case_when(date == "2022-09-06" ~ "September 2022",
                              date %in% c("2021-08-11") ~ "Summer samples",
                              date %in% c("2021-04-06", "2022-04-07") ~ "Winter samples"),
...
kable(summary)
write.csv(summary, here("water_quality", "figs", "WQ4", "summary_table.csv"))
```
...
ggarrange(ph_sarg, do_sarg, tds_sarg, turbidity_sarg, nitrates_sarg, phosphates_sarg, temperature_sarg, enterococci_sarg, salinity_sarg, conductivity_sarg, 
          ncol = 2, nrow = 5, common.legend = TRUE, legend = "top")
ggsave(here("water_quality", "figs", "WQ4", "summary_sargassum.png"), width = 6, height = 10)
```
