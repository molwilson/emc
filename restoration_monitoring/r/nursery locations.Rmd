...
york <- read_excel(here("restoration_monitoring", "data", "Nursery map.xlsx"), 
                  sheet = "York_Feb 2023", 
                  range = "A1:F9",
                  col_names = FALSE, 
                  .name_repair = letter_names)
tpb <- read_excel(here("restoration_monitoring", "data", "Nursery map.xlsx"), 
                  sheet = "TPB_Feb 2023", 
                  range = "A1:B10",
                  col_names = FALSE, 
                  .name_repair = letter_names)
...
write.csv(locations, here("restoration_monitoring", "data", "nursery locations.csv"), row.names=FALSE)
```