...
write.csv(status_nursery, here("restoration_monitoring", "data_outputs", "status_nursery_2024Dec.csv"), row.names=FALSE)
...
ggsave(here("restoration_monitoring", "figs", "bleaching_outcomes_2024v2023.png"), width = 4, height = 5)
