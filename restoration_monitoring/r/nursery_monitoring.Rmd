...
- survorship
- something indicating bleaching susceptibility?
```{r}
...
# ggsave(here("restoration_monitoring", "figs", "bleaching_outcomes_04.12.23.png"), width = 12, height = 5)
...
therm_stress_geno <- nursery_mon %>%
  ...
  left_join(nursery_mon %>%
              filter(date == "2023-12-04") %>% # comparing to most December 2023 data collection
