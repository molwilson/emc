...
genotype_tracking <- collection %>%
  ...
  arrange(genotype) %>%
  select(updated, genotype, active, productive, collection_date, collection_site, collection_lat, collection_lon, york_locations, tpb_locations, 
         # cades_locations, 
         jumby_locations, gb_locations, n_frags, n_outplanted, n_outplants, outplant_survival)
