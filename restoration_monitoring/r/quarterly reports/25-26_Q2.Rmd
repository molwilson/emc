...
q_label <- "Q2 2025-26"
q_start <- "2025-10-01"
q_end <- "2026-01-15" # extending for recent data collection

# biannual settings
b_start <- "2025-12-01" # adjusted for outplant monitoring
b_end <- "2026-01-15" # extending for recent data collection
```
...
diff_nmon <- anti_join(nurs_mon_last %>% select(nursery, location, genotype), 
  ...
  anti_join( # removing GB locations because those are not in maps by genotype
   rbind(map_york, map_tpb, map_cades, map_jumby) %>%
