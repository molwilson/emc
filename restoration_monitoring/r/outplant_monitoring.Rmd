...
ggplot(survivorship_spp, aes(x = species, y = survivorship)) +
  ...
  lims(y = c(0,100)) +
  labs(y = "Survivorship", x = "Species") +
  theme_bw() +
  theme(axis.text.x = element_text(face = "italic"))
ggsave(here("restoration_monitoring", "figs", "survivorship_spp_col.png"))
...
Comparing all genotypes across sites makes Ten Pound look the worst, but when we look only at genotypes that we've replicated across all three sites, the trends are less obvious.
