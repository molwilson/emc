...
ggsave(here("agrra_monitoring", "figs", "benthic_delta_comb.png"), width = 6, height = 6)
```
...
### Line plots
```{r}
coral_fams <- c("Acroporidae", "Merulinidae", "Milleporidae", "Montastraeidae",  "Poritidae", "Siderastreidae", "Unknown spp.")
...
fish_raw_hist <- read_excel(here("agrra_monitoring", "data_raw", "ATG_2017-2022", "Raw", "MSAccess-FishRaw.xlsx"), sheet = "Counts Raw") %>%
  ...
  mutate(phase = case_when(terminal_phase == TRUE ~ "Terminal",
                           TRUE                  ~ "Initial")) %>%
  select(year, site, site_cat, trans = transect, size_class, length_mid, common_name, common_family, family, species, phase)
