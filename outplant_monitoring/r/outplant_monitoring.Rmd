...
ggplot(monitoring %>% filter(date == as.Date("2022-09-05")),
  ...
  labs(y = "Percent survival at 2 mo.", x = "Outplant ID", fill = "Species") +
...
ggplot(monitoring %>% filter(genotype %in% c("APAL13", "APAL14", "APRO04") & date == as.Date("2022-09-05")),
  ...
  scale_fill_manual(values = c("steelblue1", "aquamarine3")) +
  labs(x = "Genotype", y = "Percent survival at 2 mo.", fill = "Outplant site") +
  lims(y = c(0,100)) +
  theme_bw()
