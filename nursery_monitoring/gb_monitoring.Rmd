...
ggsave(here("nursery_monitoring", "figs", "growth_apal_sum_jan.png"), width = 3, height = 3)
...
ggsave(here("nursery_monitoring", "figs", "growth_apal_hands_jan.png"), width = 3, height = 3)
```
